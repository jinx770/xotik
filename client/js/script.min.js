...
<<<<<<< HEAD
        </div>`,"block"==headerPopover.style.dispaly&&loginButton.click(),disableScroll()};"http://localhost:3000/index.html#listingSection"!=window.location.href&&"http://localhost:3000"!=window.location.href||handleHomeAnimals(),refreshElements(),setupEventListeners(),setupFilters();
=======
