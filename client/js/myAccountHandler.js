                ...
                <div class='user-listing' data-id='${i}'>
                  <div class='user-listing-top'>
                    <div class='user-listing-details'>
                      <div class='row'>
                        <h4 class='editable userDetailsName' data-id='${i}' contenteditable id='animalName'>${userListings.name}</h4>
                        <h4> $ <span contenteditable class='editable' data-id='${i}' id='animalPrice'>${userListings.price}</span></h4>
                      </div>
                      <h5 contenteditable='true' class='editable' data-id='${i}' id='animalLocation'>${userListings.location}</h5>
                  ...
                  <div class="user-listing-description">
                    <p id='animalDescription' data-id='${i}' contenteditable>${userListings.description}</p>
